 ...
 * #onSuccess(Object,  com.mirim.bokrim.GraphicOverlay, Bitmap)} to define what they want to with the detection results and
 * {@link #detectInImage(InputImage)} to specify the detector object.
 *
 * @param <T> The type of the detected feature.
 */
public abstract class VisionProcessorBase<T> implements  com.mirim.bokrim.VisionImageProcessor {
    ...
    private final  com.mirim.bokrim.ScopedExecutor executor;
    ...
    protected VisionProcessorBase(Context context) {
        ...
        executor = new  com.mirim.bokrim.ScopedExecutor(TaskExecutors.MAIN_THREAD);
    ...
    public void processImageProxy(ImageProxy image,  com.mirim.bokrim.GraphicOverlay graphicOverlay) {
        if (isShutdown) {
            image.close();
            return;
        }
    ...
    private Task<T> requestDetectInImage(
            ...
            final  com.mirim.bokrim.GraphicOverlay graphicOverlay,
    ...
    protected abstract void onSuccess(@NonNull T results, @NonNull  com.mirim.bokrim.GraphicOverlay graphicOverlay, Bitmap cameraImage, int framesPerSecond);
